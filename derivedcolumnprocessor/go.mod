module github.com/honeycombio/derived-column-translator-processor/derivedcolumnprocessor

go 1.25.0

require (
	github.com/honeycombio/derived-column-translator-processor v0.0.0
...
replace github.com/honeycombio/derived-column-translator-processor => ../
